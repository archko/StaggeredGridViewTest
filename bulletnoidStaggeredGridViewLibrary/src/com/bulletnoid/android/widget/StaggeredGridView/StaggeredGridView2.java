...
public class StaggeredGridView2 extends ViewGroup {
    ...
    private static final String TAG="StaggeredGridView2";
    ...
    public StaggeredGridView2(Context context, AttributeSet attrs) {
    ...
    private boolean startScrollIfNeeded(int y) {
        ...
        // scroll than a tap
        final int deltaY =(int) (y - mLastTouchY);
...
//                final int colEnd = Math.min(mColCount, nextCol + lp.span);
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(StaggeredGridView2 parent, View view, int position, long id);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(StaggeredGridView2 parent, View view, int position, long id);
    }
    ...
    public void setHeaderView(View v) {
        ...
        StaggeredGridView2.LayoutParams lp=new StaggeredGridView2.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        public void run() {
            switch (mTouchMode) {
                ...
                case TOUCH_MODE_FLINGING: {
                    ...
                    final boolean atEdge = trackMotionScroll(delta, false);
