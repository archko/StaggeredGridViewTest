 ...
 */
public class PLA_ListView2 extends PLA_AbsListView2 {
    ...
    private ArrayList<FixedViewInfo> mHeaderViewInfos=new ArrayList<PLA_ListView2.FixedViewInfo>();
    private ArrayList<FixedViewInfo> mFooterViewInfos = new ArrayList<PLA_ListView2.FixedViewInfo>();
    ...
    public PLA_ListView2(Context context) {
        this(context, null);
    }

    public PLA_ListView2(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.listViewStyle);
    }

    public PLA_ListView2(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addHeaderView(View v, Object data, boolean isSelectable) {
        ...
        if (mAdapter != null) {
            if (!(mAdapter instanceof PLA_HeaderViewListAdapter2)) {
                mAdapter = new PLA_HeaderViewListAdapter2(mHeaderViewInfos, mFooterViewInfos, mAdapter);
            }
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (mHeaderViewInfos.size()>0||mFooterViewInfos.size()>0) {
            mAdapter=new PLA_HeaderViewListAdapter2(mHeaderViewInfos, mFooterViewInfos, adapter);
        } else {
            mAdapter=adapter;
        }
    ...
    final int measureHeightOfChildren(int widthMeasureSpec, int startPosition, int endPosition,
        ...
        final PLA_AbsListView2.RecycleBin recycleBin = mRecycler;
    ...
    private void setupChild(View child, int position, int y, boolean flowDown, int childrenLeft,
        ...
        if (recycled && (((PLA_AbsListView2.LayoutParams)child.getLayoutParams()).scrappedFromPosition)
            != position) {
