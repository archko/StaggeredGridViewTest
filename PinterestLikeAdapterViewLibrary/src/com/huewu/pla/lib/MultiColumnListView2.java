...
import com.huewu.pla.lib.internal.PLA_ListView2;

/**
 * @author huewu.ynag
 * @date 2012-11-06
 */
public class MultiColumnListView2 extends PLA_ListView2 {
    ...
    public MultiColumnListView2(Context context) {
        super(context);
        init(null);
    }

    public MultiColumnListView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MultiColumnListView2(Context context, AttributeSet attrs, int defStyle) {
