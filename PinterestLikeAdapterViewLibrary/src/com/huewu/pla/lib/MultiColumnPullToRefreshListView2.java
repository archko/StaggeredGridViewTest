 ...
 * @version 1.0.0
 */
public class MultiColumnPullToRefreshListView2 extends MultiColumnListView {
    ...
    public MultiColumnPullToRefreshListView2(Context context) {
        super(context);
        init(context, null);
    }

    public MultiColumnPullToRefreshListView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MultiColumnPullToRefreshListView2(Context context, AttributeSet attrs, int defStyle) {
