...
public abstract class PullToRefreshPLAAdapterViewBase<T extends PLA_AbsListView> extends PullToRefreshBase<T> implements
    ...
    public PullToRefreshPLAAdapterViewBase(Context context, Mode mode) {
        super(context, mode);
        mRefreshableView.setOnScrollListener(this);
    }

    public PullToRefreshPLAAdapterViewBase(Context context, Mode mode, AnimationStyle animStyle) {
    ...
    public  void onScroll(final PLA_ListView view, final int firstVisibleItem, final int visibleItemCount,
    ...
    public  void onScrollStateChanged(final PLA_ListView view, final int state) {
        /**
